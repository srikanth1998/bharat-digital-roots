...
const pillars = [
  ...
  { swatch: "bg-brand-green", bg: "bg-brand-green/5", title: "Skills Development", tag: "FESYA", body: "Equipping youth, women, and community members with practical, professional, and life skills for growth and self-reliance." },
  { swatch: "bg-brand-gold", bg: "bg-brand-gold/10", title: "Opportunities Hub", tag: "FESYA", body: "Connecting people to scholarships, jobs, grants, internships, training, fellowships, and leadership opportunities." },
  { swatch: "bg-brand-saffron", bg: "bg-brand-saffron/10", title: "Charity & Community Support", tag: "All Wings", body: "Providing practical support to vulnerable individuals and families through outreach, donations, and community care initiatives." },
